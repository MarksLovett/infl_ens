#!/usr/bin/env python3
"""Build and persist the six-axis 70/10/20 stratified data split."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--config",
        default="configs/benchmark/router/six_axis_pair_merge_split.yaml",
    ...
    out = Path(args.output or ds.get("manifest", "data/splits/six_axis_seed0.json"))
